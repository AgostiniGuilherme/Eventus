...
urlpatterns = [
    ...
    path('evento/<int:evento_id>/inscrever/', views.inscricao_em_evento, name='inscricao_em_evento'),
    path('evento/<int:evento_id>/cancelar-inscricao/', views.cancelar_inscricao, name='cancelar_inscricao'),
